...
> 系统说明：本篇以 macOS 为主线演示，Windows 的不同操作会在对应步骤里单独标出。
...
> ❗ **这一步我不单独放图。**
> 你只需要记住一件事：如果看到“未知开发者”提示，就去 **系统设置 → 隐私与安全性** 里找到 **“仍要打开”**。
> 如果一时找不到入口，**直接把当前界面截图发给 AI**，让它一步一步告诉你该点哪里。
...
> **[📷 截图占位：VSCode 中 Markdown 文件左侧源码、右侧预览的分栏界面]**
![Markdown 预览界面](image/02_安装教程_图文/step6-markdown-preview.png)
如果想要更好的体验，也建议再装一个预览增强插件，它对长文档、目录和阅读体验会更友好。
